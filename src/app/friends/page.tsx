        ...
        <td>
          <div className="flex items-center space-x-3">
            <div className="avatar">
			  ...
			  <img className="user-image"  src= "./friends/UCDI.png" alt="User Image" />
              </div>
            </div>
            <div>
      ...
      <tr>
        ...
        <td>
          <div className="flex items-center space-x-3">
            <div className="avatar">
              <div className="mask mask-squircle w-12 h-12">
			  <img className="user-image"  src= "./friends/UCDI.png" alt="User Image" />              </div>
            </div>
            <div>
      ...
      <tr>
        ...
        <td>
          <div className="flex items-center space-x-3">
            <div className="avatar">
              <div className="mask mask-squircle w-12 h-12">
                <img src="./friends/UCDI.png" alt="Avatar Tailwind CSS Component" />
              </div>
            </div>
            <div>
